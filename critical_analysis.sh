...
echo "  ╚══════╝╚═╝     ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝"
echo -e "${NC}"
echo -e "${CYAN}  Singularity Container Launcher v5.1${NC}"
echo ""
...
#   RENDER_MODE=8bit   — pixel rendering (default, works in Kitty/iTerm)
#   RENDER_MODE=ascii  — colored ASCII art rendered as image
#   RENDER_MODE=bw     — monochrome ASCII art rendered as image
#   RENDER_MODE=blocks — pixelated block art rendered as image
# ---------------------------------------------------------------
